...
export const queuesDescription = [
    ...
    },
    {
        header: "третя черга",
        deadline: "Весна 2025",
        type: "Реалізація інфраструктурних проєктів",
        number: "",
        description: "а саме:",
        details: [
...
export const advantagesList = {
    ...
    "Приваблива інфраструктура":
        [
            "Ми передбачили у нашому проєкті оптимальну інфраструктуру, яка стане «магнітом» для потенційних індивідуальних і групових клієнтів (ресторан, конференц-центр, басейн, спа-комплекс, дитячий майданчик, мотузковий парк, мангальна зона, облаштування території тощо), а також вплине на тривалість їхнього перебування"
        ],
    ...
    "Адекватність і реалістичність розрахунку дохідності":
        [
            "На відміну від більшості аналогічних проєктів, ми не завищуємо показники завантаженості будиночків і не занижуємо їхню операційну витратну частину. Тому наш прогноз є валідним і реалістичним"
        ]
}
